...
if not filtered_df.empty:
    ...
    st.markdown(
        detail_data.style.set_table_styles([
            {"selector": "table", "props": [("width", "1391px"), ("table-layout", "fixed")]},
            {"selector": "th", "props": [("text-align", "center"), ("width", "1000px")]},
            {"selector": "td:nth-child(2)", "props": [("text-align", "center"), ("width", "391px")]},
